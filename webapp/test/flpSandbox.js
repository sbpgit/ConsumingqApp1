		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ConsumeApp",
									"targetURL": "#consumeconsumingapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"consumeconsumingapp-display": {
								"semanticObject": "consumeconsumingapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=consume.consumingapp",
									"url": sap.ui.require.toUrl("consume/consumingapp")
								}
							}
						}
					}
